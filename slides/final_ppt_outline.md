...
- 队伍：中国海洋大学“蓝色系统队”
- final engineering commit：`e8e2fb9`
- evidence commit：`03aad04`

**Suggested visual**  
项目标题 + “Lab0-Lab5 / integrated 0001-0007 / 三方复现 PASS” 三个标签。
...
**Key message**  
最终 `e8e2fb9` 已完成队长本机和两位队友 full verification PASS。
...
- 覆盖 doctor/check-env/baseline/apply+make/boot/all user tests
