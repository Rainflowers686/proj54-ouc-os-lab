...
11. 测试报告：`docs/04_test_report.md`
12. AI 使用记录：`docs/05_ai_usage_record.md`
13. 引用与许可证说明：`docs/08_reference_and_license.md`
14. 初赛材料索引：`submissions/draft-report-index.md`
...
| lab1 hello syscall | 已形成 patch 并验证 | patch 可从 clean baseline 应用；已捕获 `hello syscall returned 2026` |
| clean baseline 复现审查 | 已完成 stage2b | 记录见 `docs/12_lab1_patch_review.md` |
...
| lab2-lab5 | 计划中 | 后续选择 lab2 或 lab4 二选一深化 |
