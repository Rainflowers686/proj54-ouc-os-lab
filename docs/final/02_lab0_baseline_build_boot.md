...
Lab0 覆盖 `external/xv6-riscv/` 的 baseline commit、构建命令、QEMU 启动和关键输出捕获。baseline commit 为 `74f84181a3404d1d6a6ff98d342233979066ebb8`。
...
报告应写清环境、命令、baseline commit 和 boot 证据。若失败，应提供 `doctor` 输出和日志尾部。
