...
审查覆盖 current final 身份、integrated patch sequence、验证脚本、正式技术报告、PPT、证据 manifest、外部证据资产包、仓库卫生和隐私边界。

## 当前状态

current final 为 `db85947 / 0001-0009`。rain、root、z2996 三方 full verification PASS，最终演示视频和 SHA256 已登记，PPTX 已生成但答辩前仍需人工最终审阅和排练。平台提交方式需按官方要求确认。
...
不把“PPT 已生成”写成“答辩已完成”。不把“视频已录制”写成“平台已提交”。不把 historical evidence 写成 current final。
