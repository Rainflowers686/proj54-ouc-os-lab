...

{
  ...
  status_line "docs/16_patch_strategy_and_integration_plan.md" "patch strategy and integration plan" "stage4b: measured lab1/lab2 SYS-22 conflict; integrated-labs sequence planned (not yet built)"
