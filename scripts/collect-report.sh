...

{
  ...
  status_line "submissions/submission_checklist.md" "submission checklist" "stage8a submission checklist: platform compliance, Git hygiene, reproducibility, docs, videos, teammate summary, red-team review, final commands"
  status_line "submissions/demo_record.md" "demo video record" "stage8a records 3 videos outside Git, with file names/platform submission details pending"
  ...
  echo "- Video files are not committed; stage8a video status is recorded in submissions/demo_record.md."
} > "$out"
