...

{
  ...
  status_line "docs/04_test_report.md" "Test report" "includes real baseline make, boot evidence, lab1/lab2/lab4 outputs, integrated 0001-0005 evidence, and lab2 v0.2 outputs"
  ...
  echo "- xv6 baseline make, boot evidence, lab1 patched make, hello output, add2 output, pstatetest output, pcounttest output, pchildtest output, fcounttest output, and integrated sequence evidence are summarized in docs/04_test_report.md."
