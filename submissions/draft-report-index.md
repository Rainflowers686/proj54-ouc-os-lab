...
| lab4 file table observation review | `docs/20_lab4_file_table_observation_review.md` | exists | stage6a: fcount/fcounttest; independent lab4 patch and integrated 0005 verified from clean baseline |
