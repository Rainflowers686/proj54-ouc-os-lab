...
本文使用材料索引语言，描述应短、准、可核对。不得使用报告结论语气，也不得把待确认项、历史证据或生成状态写成当前正式结论。
...
| submission readiness review | `docs/21_submission_readiness_review.md` | exists | stage6d historical snapshot: full integrated 0001-0005 reproduced at that time; superseded by historical integrated 0001-0007 evidence |
...
| lab3/lab5 completion plan | `docs/24_lab3_lab5_completion_plan.md` | exists | stage9c process record with stage11b banner: described 0001-0007 state is historical; current integrated suite is 0001-0009; historical evidence recorded elsewhere |
| final project overview | `docs/final/00_project_overview.md` | exists | formal overview: OUC xv6 Lab Kit positioning, scoring weights, integrated 0001-0009, three-way PASS, historical 0001-0007 evidence boundaries |
...
| final testing and verification | `docs/final/06_testing_and_verification.md` | exists | formal testing coverage includes memstat/fdinfo; integrated 0001-0009 rain/root/z2996 full PASS; integrated 0001-0007 is historical; real-result boundaries |
| final teammate reproduction guide | `docs/final/07_teammate_reproduction_guide.md` | exists | formal teammate reproduction guide: integrated 0001-0009 full verification recorded for rain/root/z2996; integrated 0001-0007 remains historical evidence |
...
| final limits and future work | `docs/final/11_known_limits_and_future_work.md` | exists | stage11b limits: pgcount/fdcount/memstat/fdinfo observation-only scope boundaries, integrated suite 0001-0009, historical evidence boundaries, new evidence/platform/privacy/reference items still pending |
| technical report v1.0 | `docs/final/technical_report_v1.0.md` | exists | judge-facing technical report: positioning, labs, integrated 0001-0009, three-way PASS evidence, historical 0001-0007 evidence, teaching value, license/AI/limits |
| submission checklist | `submissions/submission_checklist.md` | exists | stage16 submission checklist: integrated 0001-0009 three-way PASS + new video recorded; Baidu external-asset row added; video/screenshot privacy review confirmed OK; remaining items include platform method and final rehearsal |
| demo video record | `submissions/demo_record.md` | exists | stage16: integrated 0001-0009 video metadata recorded with duration/resolution/fps/size/SHA256 (20260611 demo); old 0001-0007 video is historical evidence; 3 earlier videos are historical; no video files in Git |
| teammate reproduction record | `submissions/teammate_reproduction_record.md` | exists | stage14: integrated 0001-0009 three-way full PASS recorded with summary/screenshot SHA256 and grade-summaries 3/3 clean; historical 0001-0007 and earlier workflow records remain historical; raw files not stored in Git |
| final evidence manifest | `submissions/evidence_manifest.md` | exists | stage16 central index: integrated 0001-0009 with three-way full PASS, grade-summaries 3/3 clean, final video metadata + SHA256, 14/14 hash verification, External Asset Package link, historical 0001-0007 evidence, and non-tracked evidence policy |
...
| xv6 doctor script | `scripts/xv6/doctor.sh` | exists | stage7a2 read-only environment diagnosis: time/cwd/uname/repo status, Git repo, tools, baseline files, logs ignored, QEMU leftovers, /mnt warning; no make or QEMU run |
...
| TA summary batch parser | `scripts/grade-summaries.sh` | exists | stage13 acceptance aid (not a grader): parses teammate-verify summary blocks into one row per file; flags overall/item inconsistency, missing memstattest-fdinfotest (old suite), duplicate content, expected identity mismatch; exit 1 when attention needed |
...
| external evidence SHA256 check | `scripts/check-evidence-sha256.sh` | exists | stage14: hashes both evidence sets in place against recorded SHA256 (historical 0001-0007 plus integrated 0001-0009: video, 3 summaries, 2 screenshots); skips when evidence dir absent; latest real run 14/14 matched |
...
| lab1 add2 argint syscall patch | `patches/lab1-system-call/0002-add-argint-add2-syscall.patch` | exists | submission-ready incremental patch after 0001 |
| lab1 patch guide | `patches/lab1-system-call/README.md` | exists | apply/build/run instructions |
| lab2 pstate syscall patch | `patches/lab2-process-observation/0001-add-pstate-syscall.patch` | exists | submission-ready independent patch from clean baseline |
...
| lab3 memstat advanced optional patch | `patches/lab3-memory-and-pagetable/0002-add-memstat-syscall.patch` | exists | stage11a independent advanced patch; memstat(struct memstat*) via argaddr+copyout; SYS_memstat 22; clean-baseline round-trip verified; stage11b also integrates this as integrated 0008 (SYS_memstat 29); independent variant not teammate-verified; does not affect historical evidence |
...
| lab4 fcount syscall patch | `patches/lab4-file-table-observation/0001-add-fcount-syscall.patch` | exists | submission-ready independent patch from clean baseline |
...
| xv6 baseline metadata | `external/xv6-baseline-record.md` | exists | metadata generated; records baseline identity, make success, and boot evidence; interactive shell use remains a teaching extension |
...
| final PPT outline | `slides/final_ppt_outline.md` | exists | stage16 16-slide high-impact defense outline: lab kit story, integrated 0001-0009 facts, evidence cards, tooling map, comparison, and honest boundaries |
| final PPT source | `slides/final_ppt.md` | exists | stage16 16-slide final defense source: core story (course lab kit, not just syscalls), integrated 0001-0009 three-way PASS, 00:03:12 final video, 14/14 evidence hash, Baidu asset package, teaching value, honest boundaries |
...
- scripts/check-final-hygiene.sh and scripts/check-evidence-sha256.sh are the pre-submission gates; evidence hashes are verified in place outside Git; integrated 0001-0009 evidence has a recorded 14/14 SHA256 match.
...
- Video files are not stored in Git; final and historical video metadata plus SHA256 are recorded in submissions/demo_record.md.
- lead/root/z2996 full PASS for integrated 0001-0007 is recorded as historical evidence in submissions/teammate_reproduction_record.md; lead/root/z2996 full PASS for integrated 0001-0009 is recorded as formal evidence; earlier workflow records remain historical evidence only.
