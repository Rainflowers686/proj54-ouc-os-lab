...
| Test report template | `docs/04_test_report.md` | exists | template; real results pending |
...
| lab0 environment guide | `labs/lab0-env-setup/README.md` | exists | updated with WSL2 status and baseline steps |
...
| xv6 baseline metadata | `external/xv6-baseline-record.md` | exists | generated metadata draft; does not claim build success |
| logs directory guide | `logs/README.md` | exists | raw logs ignored by default |
...
- xv6 build and QEMU boot remain TODO until real commands are run and recorded.
