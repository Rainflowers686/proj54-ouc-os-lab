...
本目录组织最终提交材料、证据索引和复现记录，使评审能够定位 current final、historical evidence 和不入库原始证据。
...
提交材料应区分 current final、historical checkpoint、外部资产位置和剩余人工确认项。生成型索引需标注生成来源和非最终报告属性。

## 语言风格

使用证据索引语言，写清 commit、suite、文件名、SHA256 和边界。
